                        ...
                        <div class="col-md-12">
                            ...
                            <div class="filter-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Search notes here..." id="search-notes">
                                    </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="filter-form">
                                    ...
                                    <div class="form-group filter">
                                        ...
                                        <input type="text" class="form-control" placeholder="Select type" id="type">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="filter-form">
                                    ...
                                    <div class="form-group filter">
                                        ...
                                        <input type="text" class="form-control" placeholder="Select category" id="category">
                                        <img src="images/User-Profile/down-arrow.png" class="img-responsive down-arrow">
                                    </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="filter-form">
                                    ...
                                    <div class="form-group filter">
                                        ...
                                        <input type="text" class="form-control" placeholder="Select university" id="university">
                                        <img src="images/User-Profile/down-arrow.png" class="img-responsive down-arrow">
                                    </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="filter-form">
                                    ...
                                    <div class="form-group filter">
                                        ...
                                        <input type="text" class="form-control" placeholder="Select course" id="course">
                                        <img src="images/User-Profile/down-arrow.png" class="img-responsive down-arrow">
                                    </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="filter-form">
                                    ...
                                    <div class="form-group filter">
                                        ...
                                        <input type="text" class="form-control" placeholder="Select country" id="country">
                                        <img src="images/User-Profile/down-arrow.png" class="img-responsive down-arrow">
                                    </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="filter-form">
                                    ...
                                    <div class="form-group filter">
                                        ...
                                        <input type="text" class="form-control" placeholder="Select rating" id="rating">
                                        <img src="images/User-Profile/down-arrow.png" class="img-responsive down-arrow">
                                    </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="notes">
                            ...
                            <div class="rate">
                               ...
                               <img src="images/images/star.png" class="img-responsive">
                               <img src="images/images/star.png" class="img-responsive">
                               <img src="images/images/star.png" class="img-responsive">100 reviews 
                            </div>
                        </div>
                    </div>
