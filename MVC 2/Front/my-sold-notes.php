    ...
    <section id="my-sold-note">
        <div class="content-box-lg">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div id="title">My Sold Notes</div>
                    </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><img src="images/images/eye.png" alt="eye" class="img-responsive eye">
                                    <div class="dropdown">
                                            <a class="btn btn-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="images/images/dots.png" alt="dots" class="img-responsive"></a>
