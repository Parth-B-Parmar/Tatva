                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text-area" class="form-control" placeholder="Upload your notes" id="notes" required>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group description-box">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter your description" id="description" required>
                                    </div>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div id="publish-btn">
                                    ...
                                    <a class="btn btn-general smooth-scroll" href="#" title="PUBLISH" role="button" onclick="confirmBox()">Publish</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- custom -->
    <script src="js/add-notes.js"></script>
