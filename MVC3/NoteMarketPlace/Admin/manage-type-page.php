...
if (isset($_POST['popup_submit'])) {
    $typeid = $_POST['popup_id'];

    //modify the type table
    $deactive_type = mysqli_query($con, "UPDATE notetypes SET isactive=0 WHERE typeid=$typeid");
...
<body class="sticky-header">
    ...
    <div class="above-footer">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 column-padding-remover">
                    <a role="button" href="add-type.php" type="submit"
                        class="btn btn-primary blue-button-hover-white margin-l margin-top-15">add
                        Type</a>
                </div>
        ...
        function showData() {
            ...
            $.ajax({
                url: "ajax/manage-type-ajax.php",
                method: "GET",
                data: {
                    search: search_string,
                },
                success: function(result) {
                    $("#manege_type_data").html(result);
                }
            });
        }
        showData();
