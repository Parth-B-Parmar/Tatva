...
if (isset($_POST['popup_submit'])) {
    $category = $_POST['popup_id'];

    //modify the notetype table and make type inactive
    $deactive_category = mysqli_query($con, "UPDATE notecategories SET isactive=0 WHERE categoryid=$category");
...
<body class="sticky-header">
    ...
    <div class="above-footer">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 column-padding-remover">
                    <a href="add-category-page.php" role="button" type="submit"
                        class="btn btn-primary margin-l blue-button-hover-white margin-top-15">add
                        category</a>
                </div>
        ...
        function showData() {
            ...
            $.ajax({
                url: "ajax/manage-category-ajax.php",
                method: "GET",
                data: {
